...
export const projects: ProjectConfig[] = [
    {
        ...
        description: (
            ...
            <Typography variant="body1">
                ...
                &nbsp;WebSocket persistent connections using&nbsp;
                <Link href="https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api.html">API Gateway's WebSocket implementation</Link>. 
                &nbsp;Deployed with the&nbsp;
    ...
    },
    {
        ...
        description: (
            ...
            <Typography variant="body1">
                ...
                WebWorkers (for parallelism) and WebAssembly (compiled from Rust)
            </Typography>
            <Typography variant="body1">
                I wrote a <Link href="https://medium.com/capital-one-tech/optimizing-graphing-performance-on-the-web-660c88753a01">blog post</Link> with more details about performance-tuning TypeScript
            </Typography>
            <Typography variant="body1">
