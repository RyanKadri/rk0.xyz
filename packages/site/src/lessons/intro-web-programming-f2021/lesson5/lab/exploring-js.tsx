...
function ProblemPlayground({ def }: { def: ProblemDefinition }) {
    ...
    return (
        <>
            <Typography variant="h6" color="secondary"><code>{ def.expectations.functionToCall }()</code></Typography>
            <Typography variant="body1">{ def.explanation }</Typography>
            <CodePlayground mode="function" className={ classes.codePlayground }
                            intialCode={ def.code } 
