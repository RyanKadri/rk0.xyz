...
export function BrowserServerChat2({ context }: { context: PresentationContext }) {
    ...
    return (
        <ContentSlide Title="The Web - Model 2" context={context}  Content={
            <section className={ c(classes.chatColumn ) }>
                ...
                <div className={ c(classes.message, classes.serverMessage) }>
                    ...
                    Ok. First draw a rectangle starting at point 0,0. Make it 1600 pixels wide and 64 pixels tall.
                    Color it teal. Now draw the text "Courses" with its top left corner at (32, 16)...
                </div>
                <div className={ c(classes.message, classes.serverMessage) }>
                    <header>Server</header>
                    <p>Translation:</p>
