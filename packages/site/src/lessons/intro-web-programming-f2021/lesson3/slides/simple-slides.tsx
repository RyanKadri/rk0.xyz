...
export const WhatAboutPosition = generateContentSlide('What about "position"?', [
  ...
  {
    text: "Good for placing layout-independent components",
    children: ["Things like buttons, chat widgets, dialogs"],
  },
...
export const Flow = generateMediaAssistSlide(
  "Block Formatting",
  [
