...
@media (max-width: 500px) { /* <--- This is the media query */
    ...
    {
        term: "Flexbox",
        description: <>The name for the CSS "<strong>Flex</strong>ible <strong>Box</strong> Module". 
        Flexbox encompasses a number of CSS properties and styling options that allow users to create
        powerful one-dimensional layouts
        </>,
        references: [
            { display: "MDN - Flexbox Explanation", link: "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox" }
        ]
    }
]