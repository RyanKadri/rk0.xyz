    ...
    <ContentSlide
      ...
      Content={
        <ColorContainer>
          ...
          >
            <code>
              ...
              {[hexRed, hexGreen, hexBlue].map(colorComp => (
                <span className={"colorComponent"} style={{ borderColor: inverseColor }}>
                  {colorComp}
                </span>
              ))}
            </code>
          ...
          <code>=</code>
          <div className={"colorAdditionRow"}>
            <div className={"colorAdditionBlock"} style={{ backgroundColor: `#${hexRed}0000` }}></div>
            <code>+</code>
            <div className={"colorAdditionBlock"} style={{ backgroundColor: `#00${hexGreen}00` }}></div>
            <code>+</code>
            <div className={"colorAdditionBlock"} style={{ backgroundColor: `#0000${hexBlue}` }}></div>
          </div>
        </ColorContainer>
      }
    />
