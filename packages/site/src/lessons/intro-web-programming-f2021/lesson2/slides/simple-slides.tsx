...
export const RecapSlide = generateContentSlide("Recap", [
  {
    text: "XML",
    children: ["Tags", "Attributes"],
  },
  {
    text: "HTML",
    children: ["Basic Elements", "HTML is for structure not style"],
  },
  "Developer Tools",
]);
...
export const HowCSS = generateContentSlide("How does CSS work?", [
  ...
  {
    text: "CSS can conflict with itself",
    children: ['The most "specific" CSS wins', "The last evaluated CSS breaks ties"],
  },
]);
...
export const InlineStyles = generateCodeSlide(
  "Inline Styles",
  ["Inline styles are another way to style elements", "Fast in a pinch but often a bad idea"],
  {
    code: synHTML`
...
export const DownsidesInline = generateContentSlide("What's wrong with inline styles?", [
  {
    text: "Inline styles are hard to...",
    children: [
