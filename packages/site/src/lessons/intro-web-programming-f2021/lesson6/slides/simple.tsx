...
export const LogVsReturn = generateContentSlide("return vs console.log", [
  ...
  </>,
  {
    text: (
      <>
        <code>return</code> tells the caller function the result of a function
      </>
    ),
    children: ["Useful when you want to use the result of a calculation"],
  },
  {
    text: (
      <>
        <code>console.log</code> makes a logging record of a message
      </>
    ),
    children: [
...
export const TheProblem = generateContentSlide("JavaScript / Web Page Interactions", [
  {
    text: "JavaScript needs to be able to change things on a page",
    children: ["Change element text", "Add new content", "Change class, attributes, etc"],
  },
...
export const DOM = generateContentSlide("The DOM", [
  ...
  {
    text: "HTML elements each have a bunch of related properties",
    children: ["Text Content", "Attributes (class, id, styles, other)"],
  },
