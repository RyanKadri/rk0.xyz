...
export const CommonProperties = generateContentSlide("Common DOM Properties", [
    ...
    { text: <><code>element.innerHTML</code> - The HTML contents of an element</>, children: [
...
export const AttachingEvents = generateCodeSlide("Attaching Events to Elements", [
    'Event "listeners" are attached to either an HTML element or the document / window',
    { text: "One way to listen for events is adding an onEVENT attribute", children: [
...
export const EventBubbling = generateCodeSlide("Event Bubbling", [
...
export const EventDefaults = generateContentSlide("Event Defaults", [
    { text: "Some HTML elements come with baked in behaviors", children: [
...
export const AddEventListener = generateCodeSlide("addEventListener", [
