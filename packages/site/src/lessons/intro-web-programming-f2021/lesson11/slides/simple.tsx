...
export const BuiltIn = generateCodeSlide("Built-in Objects", [
...
export const HowToImport = generateCodeSlide('How to "import" libraries', [
...
export const Ports = generateContentSlide("Ports", [
    ...
    { text: "For instance, you might have...", children: [
