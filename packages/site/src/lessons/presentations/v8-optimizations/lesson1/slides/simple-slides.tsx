...
import { generateContentSlide, generateDefinitionSlide, generateMediaAssistSlide, generateMediaSlide, generateMessageSlide, generateTitleSlide } from "../../../../../../../presenter-core/src/slides/generate-slide";
...
export const CompilerPipeline = generateMediaAssistSlide("V8 Compiler Pipeline", [],
...
export const WaitButWhyFastProps = generateMediaAssistSlide("Wait but why?", [
...
export const HiddenClasses = generateMediaAssistSlide("Hidden Classes", [], 
...
export const YourOpinionMan = generateMediaSlide(
    <img src={ yourOpinion.src } />
)
...
export const references: Reference[] = [
    ...
    { label: "Deoptimizations in V8", url: "https://docs.google.com/presentation/d/1Z6oCocRASCfTqGq1GCo1jbULDGS-w-nzxkbVF7Up0u0/edit#slide=id.g19fe2e08ca_0_148" },
    { label: "An Introduction to Speculative Optimization in V8", url: "https://ponyfoo.com/articles/an-introduction-to-speculative-optimization-in-v8" }
]