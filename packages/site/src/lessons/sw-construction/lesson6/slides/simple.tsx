...
export const Title = generateTitleSlide("APIs", "Ryan Kadri");
...
export const ExampleBadApi = generateCodeSlide(
...
export const ThatBringsUsTo = generateMessageSlide("That brings us to our next assignment...");

export const references: Reference[] = [
  {
    label: "Example Solution: Assignment 3",
    url: "https://github.com/RyanKadri/spring2021-practicum-examples/tree/main/6-apis/housing-data-example",
  },
  {
    label: "Jeff Bezos API Mandate",
    url: "https://nordicapis.com/the-bezos-api-mandate-amazons-manifesto-for-externalization/",
    note: "You won't be directly tested on this but it's ",
  },
  {
