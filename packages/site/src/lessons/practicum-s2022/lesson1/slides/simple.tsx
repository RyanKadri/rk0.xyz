...
export const GitConcepts = generateContentSlide("Git Concepts", [
  {
    text: (
      <>
        <strong>Repository</strong> - A folder / set of files managed by git
      </>
    ),
    children: ["Git tracks changes to a repository over time"],
  },
  {
    text: (
      <>
...
export const GitConcepts2 = generateContentSlide("Git Concepts (continued)", [
  {
    text: (
      <>
        <strong>Branch</strong> - A pointer to a commit
      </>
    ),
    children: [
