...
import { generateCodeSlide, generateContentSlide, generateMediaAssistSlide, generateTitleSlide } from "../../../../../../presenter-core/src/slides/generate-slide";
...
export const DynamoDb = generateContentSlide("DynamoDB", [
    ...
    { text: "Documents have a primary key made of one or two values...", children: [
...
export const SettingUpAwsLibs = generateCodeSlide("Using AWS in Java", [
...
export const SettingUpDynamo = generateCodeSlide("Using Dynamo in Java", [
