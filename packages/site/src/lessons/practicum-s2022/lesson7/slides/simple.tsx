...
export const HowDoPublish = generateMessageSlide(
    "How do other people use your code?"
);

export const SoCloseSoFar = generateContentSlide("So Close", [
    <>Running code in your IDE <strong>is</strong> running a real server</>,
...
export const DataCenterOperations = generateContentSlide("Option 1: Physical Hosting", [
    "When a new team or company wants to run an app, they put it in a data center",
    'You might own for a "cabinet", a "cage", or a whole data center',
    "When you want a new app, you provision a new server",
    "This might take weeks or months",
    "You need to get the sizing right (CPU(s), Memory, etc)"
]);

export const DataCentersDownside = generateContentSlide("Physical Hosting Tradeoffs", [
    "Data centers may give users total control to customize their setup",
    "May be cheaper at very large scales",
    "You need to worry about over or under-provisioning",
    "A lot of things to worry about potentially",
]);

export const VirtualMachines = generateContentSlide("Option 2: Virtual Machines on Prem", [
...
export const DataCenterOperationsVMs = generateContentSlide("Data Center Operations (VMs)", [
    "When a new team or company wants to run an app, they put it in a VM in a data center",
    "App teams don't need to think about hardware as much",
    "Operations teams can split up their hardware capacity into smaller VMs",
    "Less over-provisioning. May allow for faster hardware upgrades",
    "Still need to think about physical hardware",
    "Still need a data center"
]);

export const CloudHosting = generateContentSlide("Option 3: Cloud Hosting", [
    "Skip the data center. Rent VMs from somebody else",
    "Sometimes referred to as Virtual Private Servers",
    "Lots of small offerings exist",
    'Larger "public cloud" companies are taking over market share',
    "This unlocks some cool possibilities"    
]);

export const CloudHostingProsCons = generateContentSlide("Cloud Hosting Pros and Cons", [
    "You do not need to think about the data center at all",
    "You can usually get a machine in minutes",
    "Billing can be a lot more flexible",
    "You can sometimes run machines in different geographic locations",
    'You can write programs that "create" hardware for you'
]);

export const HowGet = generateMessageSlide("How do I get one?!")
...
export const RunningOutsideIde = generateContentSlide("Running on the Command Line", [
    "For real apps, you often start them from the command line (or using other OS tools)",
    "You don't want your code to be dependent on the IDE",
...
export const NowHowDeploy = generateMessageSlide(
...
export const SetupCommands = generateContentSlide("VM Setup Commands", [
    ...
    { text: <><code>scp</code> - Similar syntax for uploading and downloading files to/from the server</>, children: [
