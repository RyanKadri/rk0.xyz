...
export const UserSecurity = generateContentSlide("User Security", [
    ...
    { text: <><strong>Authentication</strong> - Is a user actually who they claim to be?</>, children: [
        "A username and password are a good way to control this",
        "Secret/temporary access keys can also prove this"
    ] },
    { text: <><strong>Authorization</strong> - Is the user allowed to do what they're trying to do?</>, children: [
        "eg. in Google Docs, only some people can access some docs",
    ] },
    { text: <><strong>Accounting</strong> - Is there a record of who is doing what?</>, children: [
...
export const AccessControl = generateContentSlide("Access Control / AuthZ", [
    ...
    { text: "Are there any other important pieces of context to consider?", children: [
...
export const SamplePolicy = generateCodeSlide("Sample policy", [
...
export const AwsEntities = generateContentSlide("Core AWS Concepts", [
    ...
    { text: "Region - Literally a large geographic region where AWS has data centers", children: [
...
export const ProgrammaticUsage = generateContentSlide("Programmatic Usage", [
    ...
    <>You need to <Link href="https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-quickstart.html">configure your credentials first</Link></>
]);

export const LetsMakeUsers = generateMessageSlide(
    "Let's set up some users!"
);

export const StorageSection = generateTitleSlide(
    "Cloud Storage", 
...
export const AwsServicesIntro = generateContentSlide("AWS Services", [
    ...
    { text: "Types of services include:", children: [
