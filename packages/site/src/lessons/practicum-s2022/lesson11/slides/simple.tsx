...
export const StartupScriptExample = generateCodeSlide("Example EC2 Startup Script", [
...
export const DockerContainerCommands = generateContentSlide("Container Commands", [
  ...
  { text: <><code>docker run</code>: Run a command in a new container</>, children: [
...
export const BuildingImages = generateCodeSlide("Building Images", [
