...
export const EventLoop = generateContentSlide("Event Loop", [
  ...
  <Link href="http://latentflip.com/loupe/" target="_blank">
...
export const FetchExample = generateCodeSlide(
  "fetch",
  [
...
export const JSONExample = generateCodeSlide(
  "JSON",
  [
...
export const references: Reference[] = [
  {
    label: "An interesting blocking vs non-blocking analogy",
    url: "https://blog.codecentric.de/en/2019/04/explain-non-blocking-i-o-like-im-five/",
  },
