      ...
      Content={
        <div className={classes.colorContainer}>
          ...
          >
            ...
            <label>
              Hue
              <input type="number" min="0" max="360" value={color.h} onChange={onChange("h")} />
            </label>
            <label>
              Saturation
              <input type="number" min="0" max="100" value={color.s} onChange={onChange("s")} />
            </label>
            <label>
              Luminance
              <input type="number" min="0" max="100" value={color.l} onChange={onChange("l")} />
            </label>
          </div>
        </div>
      }
