...
import { synJS, synTS } from "../../../../common/highlighting";
...
export const NodeJS = generateCodeSlide(
  "NodeJS",
  [
...
export const TypeScript = generateCodeSlide(
  "Typescript",
  [
...
export const Frameworks = generateCodeSlide(
  ...
  {
    code: synJS`export function Header({ name }) {
    return (
