...
import { createStyles, IconButton, List, ListItem, ListItemSecondaryAction, ListItemText, makeStyles, Typography } from "@material-ui/core";
...
export default function InstructorView() {
    ...
    return (
        <div className={ classes.container }>
            <Typography variant="h4" component="h1">Recordings</Typography>
            {
                recordings.length === 0
                        ...
                        <List>
                            { recordings.map(recording => (
                                <ListItem key={ recording.startTime }>
                                    <ListItemText primary={ new Date(recording.startTime).toLocaleString() }
