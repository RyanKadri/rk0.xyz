...
export const description = "Apply CSS to an existing HTML page to recreate an image mockup. How close can you get to the target?";

# Lab 2: Introduction to HTML and CSS

## Overview

In this lab, you will apply the basics of HTML and CSS that we have learned in class so far. In the first section of the lab you will work with some common CSS selectors. For the second two parts of the lab, you will be acting in the role of a user interface designer at BookReads.com, the country's most popular (nonexistent) book review site. You will get a chance to apply your new CSS skills to style up a boring (and kinda ugly) HTML site

## Part 1 - CSS Selectors Practice

Please go to [flukeout.github.io](https://flukeout.github.io/) and do all of the CSS selector exercises. In your lab submission, please include a text file "selectors.txt" where each line is the answer to the corresponding level. For this part of the assignment, I would encourage you to try every level yourself but feel free to work with others if you would like. All other parts should be done individually
...
To get started, please download and unzip [this file](/courses/cis1052/lab1.zip) You should edit the provided CSS files to make your site look like the mock up above. I would recommend using Visual Studio Code to do this assignment and using the LiveReload plugin to get quick feedback on your work.
